...
import 'package:graduation_project/modules/Components/babyProducts.dart';
import 'package:graduation_project/layout/cubit/cubit.dart';
import 'package:graduation_project/layout/cubit/states.dart';

class BabyDio extends StatelessWidget {
  const BabyDio({Key? key}) : super(key: key);
        ...
        child: BlocConsumer<AppCubit, States>(
            ...
            builder: (BuildContext context, state) {
              ...
              return ConditionalBuilder(
                  ...
                  builder: (context) => buildBabyItems(Products));
            }));
  }
}
