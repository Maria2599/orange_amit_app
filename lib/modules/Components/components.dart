        ...
        return Scaffold(
          ...
          onTap: () {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => SingleItem(product_id: model.id!)));
          },
          child: Column(
...
Widget buildSingleItem(BuildContext context) {
  return BlocConsumer<AppCubit, States>(
      ...
      builder: (BuildContext context, state) {
        ...
        ProductModel? Products_details =
            AppCubit.get(context).productModelDetails;
        return Scaffold(
          body: Center(
            child: Padding(
...
////to make image circul
                    ClipRRect(
                      ...
                      child: Products_details!.image != null
                          ? Image(
                              image: NetworkImage(Products_details.image!),
                              fit: BoxFit.cover,
                            )
                          : Image(
                              image: NetworkImage(
                      ...
                      child: ElevatedButton(
                        ...
                        style: ButtonStyle(
                          backgroundColor: MaterialStateProperty.all(
                              Color.fromRGBO(49, 49, 173, 0.788235294117647)),
                        ),
                      ),
                    ),
                  ],
