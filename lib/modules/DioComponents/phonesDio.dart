...
import 'package:graduation_project/modules/Components/phones.dart';

class PhoneDio extends StatelessWidget {
  const PhoneDio({Key? key}) : super(key: key);
        ...
        child: BlocConsumer<AppCubit, States>(
            ...
            builder: (BuildContext context, state) {
              ...
              return ConditionalBuilder(
                  ...
                  builder: (context) => buildPhoneItems(Products));
            }));
  }
}
