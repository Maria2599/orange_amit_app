...
import 'package:graduation_project/modules/Components/healthAndBeauty.dart';

class BeautyDio extends StatelessWidget {
  const BeautyDio({Key? key}) : super(key: key);
        ...
        child: BlocConsumer<AppCubit, States>(
            ...
            builder: (BuildContext context, state) {
              ...
              return ConditionalBuilder(
                  ...
                  builder: (context) => buildBeautyItems(Products));
            }));
  }
}
