...
import 'package:graduation_project/modules/Components/superMarket.dart';

class SuperMarketDio extends StatelessWidget {
  const SuperMarketDio({Key? key}) : super(key: key);
        ...
        child: BlocConsumer<AppCubit, States>(
            ...
            builder: (BuildContext context, state) {
              ...
              return ConditionalBuilder(
                  ...
                  builder: (context) => buildSuperMarketItems(Products));
            }));
  }
}
